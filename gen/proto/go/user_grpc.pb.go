...
const (
	AuthService_GetUser_FullMethodName       = "/mcabank.user.AuthService/GetUser"
	AuthService_VerifySession_FullMethodName = "/mcabank.user.AuthService/VerifySession"
)
...
func (c *authServiceClient) VerifySession(ctx context.Context, in *VerifySessionRequest, opts ...grpc.CallOption) (*VerifySessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_VerifySession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mcabank.user.AuthService",
